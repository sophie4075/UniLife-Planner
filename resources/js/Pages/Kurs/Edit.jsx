...
export default function Create({auth, kurs}){


    const {data, setData, post, errors, reset} = useForm({
        name: kurs.name || "" ,
        description: kurs.description || "",
        exam_date: kurs.exam_date|| "",
        status: kurs.status || "",
        image: "",
        _method: "PUT",
    })

   // console.log("Dein Kurs" + JSON.stringify(kurs));
    const onSubmit = (e) => {
        e.preventDefault();
        post(route("kurs.update", kurs.id));
        ...
        <Authenticated
            ...
            header={
                <div className="flex justify-between">
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit "{kurs.name}"</h2>
                </div>
            }>
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        {kurs.image_path && <div className="text-center">
                        ...
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            ...
                            <div className="mt-4">
                                ...
                                <TextInput id="exam_date" type="date" name="exam_date" value={data.exam_date}
                                           className="mt-1 block w-full bg-gray-200"
                            ...
                            <div className="mt-4 text-right">
                                <button className="bg-emerald-500 py-1 px-3 text-white rounded shadow transition-all hover:bg-emerald-800" type="submit" >Update</button>
                                <Link
