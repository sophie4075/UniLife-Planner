        ...
        <Authenticated
            ...
            header={
                <div className="flex justify-between">
                    <h2 className="font-semibold text-xl text-gray-800 leading-tight">Create a new To-Do</h2>
                </div>
            }>

            <Head title="New To-Do"/>
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <form onSubmit={onSubmit} className="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                            <div className="mt-4">
                                ...
                                <InputError message={errors.todo_kurs_id} className="mt-2"/>
                            </div>
                            <div className="mt-4">
